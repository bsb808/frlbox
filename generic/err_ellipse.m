function [xx,yy,xxMaj,yyMaj,xxMin,yyMin] = err_ellipse(CovM,CenterXY,npts,del)

% return x,y points of a 2-d error ellipse
%  [xx,yy,xxMaj,yyMaj,xxMin,yyMin] = err_ellipse(CovM,CenterXY,N,del)
%
...
% del = 4.61 for 90% confidence (DEFAULT)
