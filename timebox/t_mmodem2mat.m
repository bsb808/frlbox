function dnum = t_mmodem2mat(dslTimeStr,dslDateStr)
...
% 11.01.06  bbing  adapted t_dsl2mat into t_mmodem2mat
%
% example...
% 
% >> tstr
...
if length(dslDateStr) == 8
   ...
   dV(3)=2000+dV(3);  %two character year
elseif length(dslDateStr) == 10
   [dV,dcount] = sscanf(dslDateStr,'%2d/%2d/%4d');
else
...
dnum = datenum(dV(3),dV(1),dV(2),tV(1),tV(2),tV(3));
